...
Начинающий программист часто при работе с временными объектами копирует их и не задумывается о накладных расходах. Тем не менее, они есть. Думаю, многим известно, что в определённых случаях копирование лучше перемещения, но не всегда можно добиться перемещения везде, где хочется. Именно поэтому я решила написать статью с примерами и картинками о таких инструментах программирования, как std::move и std::forward.
